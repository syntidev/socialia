...
const App: React.FC = () => {
  ...
  const [humanVariationManual, setHumanVariationManual] = useState({
    ...
    iluminacion: 'golden morning light from window'
  });
  ...
  const handleGenerate = async () => {
    ...
    try {
      const humanOverride = humanVariationLocked ? {
        customHumanVariation: `HUMAN_SUBJECT: A ${humanVariationManual.genero}, in a ${humanVariationManual.escena} with ${humanVariationManual.iluminacion}`
      } : {};
